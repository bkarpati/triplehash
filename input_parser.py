...
total_customers = 0
list_of_order = list()
#(number_of_row, number_of_col, number_of_drones, max_sim_time, max_drone_load, total_product_type, weight_of_product, list_of_warehouses, total_customers, list_of_order)
...
def parse_input(fileName):
    ...
    file_object.close()
    global number_of_row, number_of_col, number_of_drones, max_sim_time, max_drone_load
    return (number_of_row, number_of_col, number_of_drones, max_sim_time, max_drone_load, total_product_type, weight_of_product, list_of_warehouses, total_customers, list_of_order)
